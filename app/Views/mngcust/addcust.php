            ...
            <div class="thumbnail">
                ...
                <div class="row">
                    <div style="margin-left: 30px; margin-bottom: 5px;">
                        <form action="<?php echo URL; ?>mngcust/addSave" method="POST">
                            <br />
                            <div class="form-inline">
                                ...
                                <div class="form-group" style="width: 505px;">
                                    <div id="DivCustType" class="form-group" style="width: 370px;">
                                        ...
                                        <select name="custtype_id" class="form-control text-center"style=" width: 360px;" >
                                            ...
                                            if (isset($this->CustTypeList))
                                                foreach ($this->CustTypeList as $ctype) {
                                                    ?>
                                                    <option value="<?php echo $ctype->getCusttype_id(); ?>"><?php echo $ctype->getShortname(); ?></option>                        
                                                    <?php
                                                }
                                            ?>
                                        </select> 
                            ...
                            <div class="form-inline">
                                <div class="form-group" style="width: 570px;">
                                    <div class="form-group" style="width: 135px;">
                                        ...
                                        <select name="nature_indcorp" id="SelectNatIndCorp" onChange="showDivs(this.value);" class="form-control text-center checkbox" style=" width: 135px;" >
                                            <option value="I">Física</option>
                                            <option selected="true" value="C">Jurídica</option>
                                        </select> 
                                    </div>     
                                    <div class="form-group" style="width: 135px;">
                                        <label for="ComboCustGender">Genero:</label>
                                        <select name="gender" class="form-control text-center"style=" width: 135px;" >
                                ...
                                <div class="form-group" style="width: 505px;">
                                    <div id="DivOccuType" class="form-group" style="width: 370px;">
                                        ...
                                        <select name="custoccutype_id" class="form-control text-center" style=" width: 360px;" >
                                            ...
                                            if (isset($this->OCCuTypeList))
                                                foreach ($this->OCCuTypeList as $octype) {
                                                    ?>
                                                    <option value="<?php echo $octype->getOccupation_id(); ?>"><?php echo $octype->getShortname(); ?></option>                        
                                                    <?php
                                                }
                                            ?>
                                        </select> 
                            ...
                            <div class="form-inline">
                                <div>
                                    <input type="hidden" name="nextid" value="<?php echo $this->CustID; ?>">
                                </div>                                    
                                <div class="form-group" id="CustDivDesc1PJ">
                                    <div class="form-group" style="width: 570px; border: 0px #b92c28 solid;">
                                        ...
                                        <div>
                                            <input type="text"  style="width: 545px;" class="form-control text-center" autofocus name="corpname" id="InputRazao" placeholder="Razão Social"  pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                        </div>
                                    </div>
                                    <div class="form-group" id="CustDivDesc2PJ" style="width: 475px;">
                                        <label for="InputAliasName">Nome Fantasia:</label>
                                        <div>
                                            <input type="text" style="width: 475px;" class="form-control text-center"  name="aliasname" id="InputAliasName" placeholder="Nome Fantasia" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                        </div>
                                    </div> 
                                </div>
                                <div class="form-group hidden" id="CustDivDesc1PF">
                                    <div class="form-group" style="width: 570px;">
                                        ...
                                        <div>
                                            <input type="text"  style="width: 545px;" class="form-control text-center" autofocus name="longname" id="InputLongName" placeholder="Nome Completo" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                        </div>
                                    </div>
                                    <div class="form-group" id="CustDivDesc2PF" style="width: 475px;">
                                        <label for="InputShortName">Nome Curto:</label>
                                        <div>
                                            <input type="text" style="width: 475px;" class="form-control text-center"  name="shortname" id="InputShortName" placeholder="Nome Curto" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                        </div>
                                    </div>                       
                                </div>
                            </div>
                            ...
                            <div class="form-inline" id="CustDivPJ">
                                <div class="form-group" style="width: 570px;">
                                    <div class="form-group" style="width: 280px;">                                 
                                        ...
                                        <div>
                                            <input type="text" style="width: 260px;"  class="form-control text-center" autofocus name="numcnpj" id="InputCnpj" placeholder="00.000.000/0000-00" onkeyup="maskIt(this, event, '##.###.###/####-##')" pattern="\d{2}.\d{3}.\d{3}/\d{4}-\d{2}">
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 280px;">
                                        <label for="InputIE">I.E.:</label>
                                        <div>
                                            <input type="text" style="width: 260px;" class="form-control text-center" autofocus name="numie" id="InputIE" placeholder="000.000.000.000" onkeyup="maskIt(this, event, '###.###.###.###')" pattern="\d{3}.\d{3}.\d{3}.\d{3}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-inline">
                                <div class="form-group hidden" id="CustDivPF" style="width: 570px; border: 0px #b92c28 solid;">
                                    <div class="form-group" style="width: 280px;">                                 
                                        ...
                                        <div>
                                            <input type="text" style="width: 260px;"  class="form-control text-center" autofocus name="numcpf" id="InputCpf" placeholder="000.000.000-00" onkeyup="maskIt(this, event, '###.###.###-##')" pattern="\d{3}.\d{3}.\d{3}-\d{2}">
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 280px;">
                                        <label for="InputRG">RG.:</label>
                                        <div>
                                            <input type="text" style="width: 260px;" class="form-control text-center" autofocus name="numrg" id="InputRG" placeholder="00.000.000-00" onkeyup="maskIt(this, event, '##.###.###-##')" pattern="\d{2}.\d{3}.\d{3}-\d{2}">
                                        </div>
                                    </div>
                                </div>                                
                            </div>
                                            ...
                                            <div class="panel panel-primary"  style="width: 1065px; margin-top: 15px; margin-bottom: 15px; margin-right: 20px;">
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 570px; border: 0px #b92c28 solid;">
                                                            <div class="form-group" style="width: 200px; border: 0px #b92c28 solid;">
                                                                <label class="control-label" for="InputCommZipCode">Cep:</label>
                                                                <input type="text" style="width: 195px;" class="form-control text-center" autofocus name="comm_addr_zip" id="InputCommZip" placeholder="Cep" onkeyup="maskIt(this, event, '#####-###')" required pattern="[0-9]{5}-[0-9]{3}">
                                                                <input type="hidden" name="comm_addr_id" id="CommAddrId">
                                                            </div>
                                                        ...
                                                        <div class="form-group"  style="width: 450px;">
                                                            ...
                                                            <div class="form-group" style="width: 100px;">
                                                                ...
                                                                <input type="checkbox" style="width: 30px;" onchange="sendData();" class="form-control text-center" autofocus name="addrinvboth" id="CheckBoxYesNo">
                                                            </div>
                                                        </div> 
                                                    </div>
                                                    ...
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 510px;">
                                                            <div class="form-group" style="width: 400px;">
                                                                ...
                                                                <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="comm_address" id="InputCommAddress" placeholder="Endereço" required pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                            </div>
                                                            <div class="form-group" style="width: 100px;">
                                                                <label class="control-label" for="InputCommAddrNumber">Número:</label>
                                                                <input type="text" style="width: 100px;" class="form-control text-center" autofocus name="comm_addr_number" id="InputCommAddrNumber" placeholder="Número" pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,15}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group" style="width: 510px;">
                                                            <label for="InputCommAddrComp">Complemento:</label>
                                                            <div>
                                                                <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="comm_addr_comp" id="InputCommAddrComp" placeholder="Complemento.." pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                            </div>                                                        
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">                  
                                                        <div class="form-group" style="width: 510px;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="comm_addr_dist" id="InputCommAddrDist" placeholder="Bairro ou Localidade" required pattern="[a-z\u00C0-\u00ffA-Z,._-\s]{0,30}">
                                                            </div> 
                                                        </div>  
                                                        <div class="form-group" style="width: 510px;">
                                                            <div class="form-group" style="width: 400px;">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="comm_addr_city" id="InputCommAddrCity" placeholder="Cidade" required pattern="[a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group"  style="width: 100px;">
                                                                <label for="InputCommAddrState">Estado:</label>
                                                                <div>
                                                                    <input type="text" style="width: 100px;" class="form-control text-center" autofocus name="comm_addr_state" id="InputCommAddrState" placeholder="Estado" required pattern="[a-zA-Z]{0,2}">
                                                                </div>
                                                            </div>   
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 510px;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 510px;" class="form-control text-center" autofocus name="comm_addr_ref" id="InputCommAddrRef" placeholder="Referência.." pattern="[a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                            </div> 
                                                        </div>
                                                    </div>                                                
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 500px;">
                                                            <div class="form-group" style="width: 500px;">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="commercial_contact_name" id="InputCommContact" placeholder="Contato Comercial" pattern="[a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                                </div>
                                                            </div>
                                                        </div>                                                        
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 500px;">
                                                                ...
                                                                <div>
                                                                    <input type="email" style="width: 500px;" class="form-control text-center" name="comm_email" id="InputCommEmail" placeholder="nome@provedora.com.br">
                                                                </div>
                                                            </div>     
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 225px;">
                                                                ...
                                                                <div>
                                                                    <input type="tel" style="width: 225px;" class="form-control text-center" autofocus name="comm_business_phone" id="InputCommBusinessPhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group"  style="width: 225px;">
                                                                <label for="InputCommMobilPhone">Telefone Celular:</label>
                                                                <div>
                                                                    <input type="tel" style="width: 225px;" class="form-control text-center" autofocus name="comm_mobil_phone" id="InputCommMobilPhone" placeholder="(00)00000-0000" onkeyup="maskIt(this, event, '(##)#####-####')" pattern="\([0-9]{2}\)([0-9\s-]{1})?[0-9]{4}-[0-9]{4}">
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 225px; ">
                                                                ...
                                                                <div>
                                                                    <input type="tel" style="width: 225px;" class="form-control text-center" autofocus name="comm_nextel_phone" id="InputCommNextelPhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                                </div>
                                                            </div>  
                                                            <div class="form-group"  style="width: 225px; ">
                                                                <label for="InputCommNextelID">Nextel ID:</label>
                                                                <div>
                                                                    <input type="text" style="width: 225px;" class="form-control text-center" autofocus name="comm_nextel_id" id="InputCommNextelID" placeholder="0000000" pattern="[0-9*]{0,15}">
                                                                </div>
                                                            </div>  
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 225px; ">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width:225px;" class="form-control text-center" autofocus name="comm_fax_phone" id="InputCommFax" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        ...
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 500px; ">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width:500px;" class="form-control text-center" autofocus name="comm_webpage" id="InputCommWebpager" placeholder="http://www.site.com.br" pattern="[a-zA-Z\u00C0-\u00ff\s./:]{0,50}">
                                                                </div>
                                                            </div> 
                                                        </div>     
                                                    </div>                                             
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group"  style="width: 1000px;">
                                                            ...
                                                            <div>
                                                                <textarea class="form-control left" style="width: 1030px;" name="comm_note" id="InputCommNote" pattern="[a-z\u00C0-\u00ffA-Z,._-\s]{0,600}"></textarea>                                        
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-inline" style="margin-top: 12px; margin-left: 5px; margin-bottom: 12px;">
                                                        <div class="form-group" style="width: 570px;">
                                                            <div class="form-group" style="width: 200px;">
                                                                ...
                                                                <input type="text" style="width: 195px;" class="form-control text-center" autofocus name="inv_addr_zip" id="InputInvZip" placeholder="Cep" onkeyup="maskIt(this, event, '#####-###')" pattern="[0-9]{5}-[0-9]{3}">
                                                                <input type="hidden" name="inv_addr_id" id="InvAddrId">
                                                            </div>
                                                            <div class="form-group"  style="width: 350px; margin-top: 18px; border: 0px #b92c28 solid;">
                                                                <div class="form-group" style="width: 150px;">
                                                    ...
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 510px;">
                                                            <div class="form-group" style="width: 400px;">
                                                                ...
                                                                <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="inv_address" id="InputInvAddress" placeholder="Endereço" required pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                            </div>
                                                            <div class="form-group" style="width: 100px;">
                                                                <label class="control-label" for="InputInvAddrNumber">Número:</label>
                                                                <input type="text" style="width: 100px;" class="form-control text-center" autofocus name="inv_addr_number" id="InputInvAddrNumber" placeholder="Número" pattern="[0-9a-z\u00C0-\u00ffA-Z._-\s]{0,15}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group" style="width: 510px;">
                                                            <label for="InputInvAddrComp">Complemento:</label>
                                                            <div>
                                                                <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="inv_addr_comp" id="InputInvAddrComp" placeholder="Complemento.." pattern="[0-9a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                            </div>                                                        
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">                  
                                                        <div class="form-group" style="width: 510px;">
                                                            <div class="form-group"  style="width: 400px;">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="inv_addr_dist" id="InputInvAddrDist" placeholder="Bairro ou Localidade" required pattern="[0-9a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                                                </div>
                                                            </div>
                                                        </div>  
                                                        <div class="form-group" style="width: 510px;">
                                                            <div class="form-group" style="width: 400px;">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="inv_addr_city" id="InputInvAddrCity" placeholder="Cidade" required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group"  style="width: 100px;">
                                                                <label for="InputInvAddrState">Estado:</label>
                                                                <div>
                                                                    <input type="text" style="width: 100px;" class="form-control text-center" autofocus name="inv_addr_state" id="InputInvAddrState" placeholder="Estado" required pattern="[a-zA-Z]{0,2}">
                                                                </div>
                                                            </div>   
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 510px;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 510px;" class="form-control text-center" autofocus name="inv_addr_ref" id="InputInvAddrRef" placeholder="Referência.." pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                            </div> 
                                                        </div>
                                                    </div>   
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" style="width: 500px;">
                                                            <div class="form-group" style="width: 500px;">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="invoice_contact_name" id="InputInvContact" placeholder="Contato de Cobrança" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                                </div>
                                                            </div>
                                                        </div>                                                        
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 500px;">
                                                                ...
                                                                <div>
                                                                    <input type="email" style="width: 500px;" class="form-control text-center" name="inv_email" id="InputInvEmail" placeholder="nome@provedora.com.br">
                                                                </div>
                                                            </div>     
                                                        </div>
                                                    </div>                                                    
                                                    ...
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 225px;">
                                                                ...
                                                                <div>
                                                                    <input type="tel" style="width: 225px;" class="form-control text-center" autofocus name="inv_business_phone" id="InputInvBusinessPhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group"  style="width: 225px;">
                                                                <label for="InputInvMobilPhone">Telefone Celular:</label>
                                                                <div>
                                                                    <input type="tel" style="width: 225px;" class="form-control text-center" autofocus name="inv_mobil_phone" id="InputInvMobilPhone" placeholder="(00)00000-0000" onkeyup="maskIt(this, event, '(##)#####-####')" pattern="\([0-9]{2}\)([0-9\s-]{1})?[0-9]{4}-[0-9]{4}">
                                                                </div> 
                                                            </div>
                                                        </div>
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 225px; ">
                                                                ...
                                                                <div>
                                                                    <input type="tel" style="width: 225px;" class="form-control text-center" autofocus name="inv_nextel_phone" id="InputInvNextelPhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                                </div>
                                                            </div>  
                                                            <div class="form-group"  style="width: 225px; ">
                                                                <label for="InputInvNextelID">Nextel ID:</label>
                                                                <div>
                                                                    <input type="text" style="width: 225px;" class="form-control text-center" autofocus name="inv_nextel_id" id="InputInvNextelID" placeholder="0000000" pattern="[0-9*]{0,15}">
                                                                </div>
                                                            </div>  
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group"  style="width: 500px;">
                                                            <div class="form-group"  style="width: 225px; ">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width:225px;" class="form-control text-center" autofocus name="inv_fax_phone" id="InvInputFax" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                                </div>
                                                            </div> 
                                                        </div>
                                                    </div>
                                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group"  style="width: 1000px;">
                                                            ...
                                                            <div>
                                                                <textarea class="form-control left" style="width: 1030px;" name="inv_note" id="InputInvNote" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,600}"></textarea>                                        
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                <div class="form-group"  style="width: 1000px;">
                                    ...
                                    <div>
                                        <textarea class="form-control left" style="width: 1030px;" name="note" id="InputCustomerNote" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,600}"></textarea>                                        
                                    </div> 
                                </div>
                            </div>
                            <div class="form-inline">
