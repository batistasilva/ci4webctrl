        ...
        <div class="row well" style="margin-top:0px; margin-left:0px; margin-right: 0px; margin-bottom: 0px;">
            <div class="thumbnail">
                <span class="thumbnail muted text-center" style="background: #3072AB; font-weight: bold; color: #FFFFFF;">
                    <strong>Cadastro de Aplicações do Sistema</strong>
                </span>  
                <?php
                $this->smsg = new SMsg();
                ...
                <div class="row">
                    <div style="margin-left: 30px; margin-bottom: 5px;">
                        <form id="StaffSearchFormUser" onsubmit="return beforeFormSubmit()" action="<?php echo URL; ?>mngurls/addSave"  method="POST" >
                                ...
                                <div class="form-group" style="width: 1060px; border: 0px #b92c28 solid;">
                                    <div class="panel panel-primary"  style="width: 1060px; margin-top: 15px; margin-bottom: 15px; margin-right: 20px;">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Aplicação do Sistema...</h3>
                                        </div>
                                            ...
                                            <div class="form-inline" style="width: 1060px; border: 0px #b92c28 solid;">
                                                <div class="form-group" style="width: 1060px; border: 0px #b92c28 solid;">
                                                    <div class="form-group" style="width: 510px;">
                                                        ...
                                                        <input type="text" style="width: 510px;" class="form-control text-center" autofocus name="page" id="InputUrl">
                                                    </div>
                                                    <div class="form-group" style="width: 510px;">
                                                        <label class="control-label" for="InputAppName">Nome da Aplicação:</label>
                                                        <input type="text" style="width: 510px;" class="form-control text-center" autofocus name="app_name" id="InputAppName">
                                                    </div>                                               
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-inline" style="width: 1060px; border: 0px #b92c28 solid;">
                                        <div class="form-group" style="width: 1060px; border: 0px #b92c28 solid;">
                                            ...
                                            <div>
                                                <textarea class="form-control left" style="width: 1030px;" name="note" id="InputNote"></textarea>                                        
                                            </div> 
                                        </div>
                                    </div>
                                </div>
