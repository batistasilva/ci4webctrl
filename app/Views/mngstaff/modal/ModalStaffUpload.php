                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="upload-wrapper">
                            <div align="center">
                                <form action="<?php echo URL; ?>mngstaff/UploadFile" method="post" enctype="multipart/form-data" id="MyUploadForm">
                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                        ...
                                        <input type="hidden" id="LocalID" name="acronym"/>
    ...
    <script type="text/javascript">
        ...
        function beforeSubmit() {
            ...
            if (window.File && window.FileReader && window.FileList && window.Blob)
            {
                ...
                if (!$('#Name').val()) {
                    $("#output").html("Campo Nome, Precisa ser Preenchido!");
                    return false;
                }
                
                if (!$('#Surname').val()) {
                    $("#output").html("Campo Sobrenome, Precisa ser Preenchido!");
                    return false;
                }
