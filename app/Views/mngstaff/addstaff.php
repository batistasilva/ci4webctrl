...
<?php include('modal/ModalStaffUpload.php'); ?>
            ...
            <div class="thumbnail">
                ...
                <div class="row">
                    <div style="margin-left: 30px; margin-bottom: 5px;">
                        <form action="<?php echo URL; ?>mngstaff/addSave" method="POST">
                            <br />
                            ...
                            <div class="form-inline">
                                <div>
                                    <input id="InputHStaffID" type="hidden" name="staff_id"  value="<?php echo $this->StaffPer->getStaff_id(); ?>">
                                    <input id="InputHPersonID" type="hidden" name="person_id" value="<?php echo $this->StaffPer->getPerson_id(); ?>">     
                                </div>                                    
                                ...
                                <div class="panel-body">
                                    <div class="tabbable tabs-below">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#PersonalData1" data-toggle="tab">Dados Pessoais</a></li><!--Inicio da Aba Dados Pessoais -->
                                            ...
                                            <div class="tab-pane active" id="PersonalData1">
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                    <div class="form-group" style="width: 510px;">
                                                        ...
                                                        <div>
                                                            <input type="text"  style="width: 500px;" class="form-control text-center" autofocus name="name" id="InputName" placeholder="Nome/Nome do Meio..." required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                        </div>
                                                    </div>                                    
                                                    ...
                                                    <div class="form-group" id="StaffName" style="width: 510px;">
                                                        ...
                                                        <div>
                                                            <input type="text" style="width: 500px;" class="form-control text-center"  name="surname" id="InputSurname" placeholder="Sobrenome..." required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                                        </div>
                                                    </div>  
                                                </div>                                                  
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                    <div class="form-group" style="width: 510px;">
                                                        <div class="form-group" id="BirthDate" style="width: 165px;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 165px;" class="form-control text-center"  name="birthdate" id="InputBirthDate" onkeyup="maskIt(this, event, '##-##-####')" required placeholder="00-00-0000">
                                                            </div>
                                                        </div> 
                                                    ...
                                                    <div class="form-group" style="width: 510px;">
                                                        ...
                                                        <div class="form-group" style="width: 120px;">
                                                            ...
                                                            <select name="maritalstate" onchange="changeForMaritalState(this.value)" class="form-control text-center" style=" width: 120px;" >
                                                                <option value="SG">Solteiro(a)</option>
                                                                <option value="MR">Casado(a)</option>
                                                                <option value="ST">União Estável</option><!--Stable Union -->
                                                                <option value="SP">Separado(a)</option><!--Separeted -->
                                                                <option value="WD">Viuvo(a)</option>                                            
                                                            </select> 
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                        <div class="form-group" id="DivStaffNaturality" style="width: 510px;">
                                                            <div class="form-group" id="DivNaturality" style="width: 320px;">
                                                                ...
                                                                <div>
                                                                    <input type="text" style="width: 320px;" class="form-control text-center"  name="naturality" id="InputNaturality" placeholder="Naturalidade" required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group" id="StaffNaturalityState" style="width: 90px;">
                                                                <label for="InputNaturalityState">Estado:</label>
                                                                <div>
                                                                    <input type="text" style="width: 90px;" class="form-control text-center"  name="naturality_state" id="InputNaturalityState" placeholder="Estado" required pattern="[a-z\u00C0-\u00ffA-Z]{0,2}">
                                                                </div>
                                                            </div> 
                                                            <div class="form-group" id="StaffBloodPerson" style="width: 90px;">
                                                                <label for="InputBloodPerson">Raça:</label>
                                                                <div>
                                                                    <input type="text" style="width: 90px;" class="form-control text-center"  name="blood_person" id="InputBloodPerson" placeholder="Raça" required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                                                </div>
                                                            </div>                                                                
                                                        </div>
                                                        <div class="form-group" id="DivStaffColorPerson" style="width: 510px;">
                                                            <div class="form-group" id="StaffColorPerson" style="width: 165px;">
                                                                <label for="InputColorPerson">Cor:</label>
                                                                <div>
                                                                    <input type="text" style="width: 165px;" class="form-control text-center"  name="color_person" id="InputColorPerson" placeholder="Cor" required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,20}">
                                                                </div>
                                                            </div>                                                              
                                                        </div>                                                        
                                                    </div>
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="form-group" style="width: 330px;">                                                                      
                                                                        <div>
                                                                            ...
                                                                            <input type="radio" style="width: 100px;"  class="form-control text-center" autofocus name="firstjob" value="Y" id="InputStaffFirstJob">
                                                                            <label for="InputStaffSecondJob">Não:</label>
                                                                            <input type="radio" style="width: 100px;" class="form-control text-center" autofocus name="firstjob" value="N" id="InputStaffSecondJob">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="form-group" style="width: 400px;">                                                                      
                                                                        <div>
                                                                            ...
                                                                            <input type="radio" style="width: 100px;"  class="form-control text-center" autofocus name="special_nebe" value="Y" required id="InputStaffSpecialNeedsBearerYes">
                                                                            <label for="InputStaffSpecialNeedsBearerNo">Não:</label>
                                                                            <input type="radio" style="width: 100px;" class="form-control text-center" autofocus name="special_nebe"  value="N" required id="InputStaffSpecialNeedsBearerNo">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="tab-pane" id="FamilyData">
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                    <div class="form-group" style="width: 335px;">
                                                        ...
                                                        <div>
                                                            <input type="text"  style="width: 335px;" class="form-control text-center" autofocus name="fathername" id="InputFatherName" placeholder="Nome do Pai..." pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                        </div>
                                                    </div>   
                                                    <div class="form-group" id="StaffName" style="width: 335px;">
                                                        <label for="InputMotherName">Nome da Mãe:</label>
                                                        <div>
                                                            <input type="text" style="width: 335px;" class="form-control text-center"  name="mothername" id="InputMotherName" placeholder="Nome da Mãe..." pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                        </div>
                                                    </div>                                     
                                                    <div class="form-group" id="WifesName" style="width: 335px;">
                                                        <label for="InputWifesName">Nome do Cônjuge:</label>
                                                        <div>
                                                            <input type="text" style="width: 335px;" class="form-control text-center"  name="wifesname" id="InputWifesName" placeholder="Nome do Cônjuge..." pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> 
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group" style="width: 495px; height: 50px;">
                                                                    ...
                                                                    <div class="form-group" style="width: 160px;"> 
                                                                        <div>
                                                                            <input type="text" style="width: 160px;" class="form-control text-center" autofocus name="organissuer" id="InputRGOrganIssuer" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 160px;">
                                                                        <div>
                                                                            <input type="text" style="width: 160px;" class="form-control text-center" autofocus name="dateofchip" id="InputRGDateOfChipment" onkeyup="maskIt(this, event, '##-##-####')" required placeholder="00-00-0000">
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body" id="DicCr">
                                                                <div class="form-group" style="width: 495px; height: 50px;">
                                                                    <div class="form-group" style="width: 160px;">                                 
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="numcrsm" id="InputCrsm" placeholder="000.000.000-00" onkeyup="maskIt(this, event, '###.###.###.###')" pattern="\d{3}.\d{3}.\d{3}.\d{3}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group" style="width: 495px; height: 50px;">
                                                                    <div class="form-group" style="width: 160px;">                                 
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="ctps" id="InputCtps" placeholder="0000000" onkeyup="maskIt(this, event, '#######')" required pattern="[0-9]{0,7}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 160px;">      
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="ctpsserie" id="InputCtpsSerie" placeholder="0000000" onkeyup="maskIt(this, event, '#######')" required pattern="[0-9]{0,7}">
                                                                        </div>
                                                                    </div>                                                        
                                                                    <div class="form-group" style="width: 160px;">                                 
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="dateofissue" id="InputDateofIssue" placeholder="00-00-0000" onkeyup="maskIt(this, event, '##-##-####')" required pattern="\d{2}-\d{2}-\d{4}">
                                                                        </div>
                                                                    </div>                                                                                                              
                                                                </div>
                                                            </div>                                                        
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group" style="width: 495px; height: 50px;"> 
                                                                    <div class="form-group" style="width: 160px;">
                                                                        <div>
                                                                            <input type="text" style="width: 160px;" class="form-control text-center" autofocus name="pispasep" id="InputPisPasep" required pattern="[0-9]{0,15}">
                                                                        </div>
                                                                    </div> 
                                                                    <div class="form-group" style="width: 160px; border: 0px #b92c28 solid;">
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="yearlastcontrib" id="InputYearLastContrib" placeholder="0000" onkeyup="maskIt(this, event, '####')" pattern="\d{4}">
                                                                        </div>                                                       
                                                                    </div>
                                                                    <div class="form-group" style="width: 160px; border: 0px #b92c28 solid;">
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="certnascmaryd" id="InputCertNascMaryd" placeholder="000000" onkeyup="maskIt(this, event, '######')" pattern="[0-9]{0,10}">
                                                                        </div>                                                       
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group" style="width: 495px; height: 50px;">  
                                                                    <div class="form-group" style="width: 160px;">                                 
                                                                        <div>
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="numcnh" id="InputCnh" placeholder="000.000.000-00" onkeyup="maskIt(this, event, '###.###.###-##')" pattern="\d{3}.\d{3}.\d{3}-\d{2}">
                                                                        </div>
                                                                    </div>  
                                                                    <div class="form-group" style="width: 160px;"> 
                                                                        <div class="form-group" style="width: 160px;">  
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="cnhcat" id="InputCnhCat">
                                                                        </div> 
                                                                    </div> 
                                                                    <div class="form-group" style="width: 160px;"> 
                                                                        <div class="form-group" style="width: 160px;">  
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="cnhdateexpire" id="InputCnhDateExpire" onkeyup="maskIt(this, event, '##-##-####')" placeholder="00-00-0000" pattern="\d{2}-\d{2}-\d{4}">
                                                                        </div> 
                                                                    </div>  
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group" style="width: 495px; height: 50px;">                                                                      
                                                                    <div class="form-group" style="width: 160px;">
                                                                        <div>
                                                                            <input type="text" style="width: 160px;" class="form-control text-center" autofocus name="titlevote" required id="InputTitleVote" pattern="[0-9]{0,12}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 160px;">     
                                                                        <div class="form-group" style="width: 160px;">                                                               
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="titlevotesec" required id="InputTitleVoteSec" pattern="[0-9]{0,5}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 160px;"> 
                                                                        <div class="form-group" style="width: 160px;">  
                                                                            <input type="text" style="width: 160px;"  class="form-control text-center" autofocus name="titlevotezn" required id="InputTitleVoteZone"  pattern="[0-9]{0,5}">
                                                                        </div> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                    <div class="form-group" style="width: 500px; border: 0px #b92c28 solid;"> 
                                                        <div class="form-group" id="StaffDivDateAdm" style="width: 170px; border: 0px #b92c28 solid;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 165px;" class="form-control text-center"  name="dateadm" id="InputDateAdm" onkeyup="maskIt(this, event, '##-##-####')" required placeholder="00-00-0000" pattern="\d{2}-\d{2}-\d{4}">
                                                            </div>
                                                        </div> 
                                                                ...
                                                                <select name="department_id" class="form-control text-center" style=" width: 210px;" >
                                                                    ...
                                                                    if (isset($this->DepartList))
                                                                        foreach ($this->DepartList as $depart) {
                                                                            ?>
                                                                            <option value="<?php echo $depart->getDepartment_id(); ?>"><?php echo $depart->getShortname(); ?></option>                        
                                                                            <?php
                                                                        }
                                                                    ?>
                                                                </select> 
                                                    ...
                                                    <div class="form-group" style="width: 510px; border: 0px #b92c28 solid;">
                                                        <div class="form-group" style="width: 165px;">
                                                            ...
                                                            <input type="text" style="width: 165px;" class="form-control text-center" autofocus name="workload" required id="InputWorkload">
                                                        </div>
                                                        <div class="form-group" style="width: 165px;">
                                                            <label class="control-label" for="InputStartTime">Hora de Entrada:</label>
                                                            <input type="text" style="width: 165px;" class="form-control text-center" autofocus name="starttime" required id="InputStartTime" placeholder="00:00" onkeyup="maskIt(this, event, '##:##')"  pattern="[0-9:\u00C0-\u00ff]{0,5}">
                                                        </div>
                                                        <div class="form-group"  style="width: 165px;">
                                                            <label for="InputEndTime">Hora de Saída:</label>
                                                            <input type="text" style="width: 165px;" class="form-control text-center" autofocus name="endtime" required id="InputEndTime" placeholder="00:00" onkeyup="maskIt(this, event, '##:##')" pattern="[0-9:\u00C0-\u00ff]{0,5}">
                                                        </div>  
                                                    </div>
                                                </div>
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="form-group" style="width: 195px; height: 50px;">                                                                      
                                                                        <div>
                                                                            <input type="text" style="width: 170px;" class="form-control text-center" autofocus name="salary" required id="InputSalary" placeholder="0,00"  pattern="[0-9,]{0,15}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>                                              
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="form-group" style="width: 290px; height: 50px;">                                                                      
                                                                        <div>
                                                                            ...
                                                                            <input type="radio" style="width: 100px;"  class="form-control text-center" autofocus name="transpticket" value="Y" required id="InputStaffTranportTicketYes">
                                                                            <label for="InputStaffTransportTicketNo">Não:</label>
                                                                            <input type="radio" style="width: 100px;" class="form-control text-center" autofocus name="transpticket" value="N" required id="InputStaffTransportTicketNo">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group" style="width: 495px; height: 50px;">                                                                      
                                                                    <div class="form-group" style="width: 60px;">
                                                                        <div>
                                                                            <input type="text" style="width: 60px;" class="form-control text-center" autofocus name="transptkqt1" placeholder="00" id="InputTranspTkQt1" pattern="[0-9]{0,15}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 90px;">     
                                                                        <div class="form-group" style="width: 90px;">                                                               
                                                                            <input type="text" style="width: 90px;"  class="form-control text-center" autofocus name="transptkvl1" placeholder="0,00" onkeyup="maskIt(this, event, '#,##')" id="InputTranspTkVl1" pattern="[0-9,.]{0,15}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 60px;">
                                                                        <div>
                                                                            <input type="text" style="width: 60px;" class="form-control text-center" autofocus name="transptkqt2" placeholder="00" id="InputTranspTkQt2" pattern="[0-9,.]{0,2}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 90px;">     
                                                                        <div class="form-group" style="width: 90px;">                                                               
                                                                            <input type="text" style="width: 90px;"  class="form-control text-center" autofocus name="transptkvl2" placeholder="0,00" onkeyup="maskIt(this, event, '#,##')" id="InputTranspTkVl2" pattern="[0-9,.]{0,15}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 60px;">
                                                                        <div>
                                                                            <input type="text" style="width: 60px;" class="form-control text-center" autofocus name="transptkqt3" placeholder="00" id="InputTranspTkQt3" pattern="[0-9]{0,2}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group" style="width: 90px;">     
                                                                        <div class="form-group" style="width: 90px;">                                                               
                                                                            <input type="text" style="width: 90px;"  class="form-control text-center" autofocus name="transptkvl3" placeholder="0,00" onkeyup="maskIt(this, event, '#,##')" id="InputTranspTkVl3" pattern="[0-9,.]{0,15}">
                                                                        </div>
                                                                    </div>                                                                        
                                                                </div>
                                                            </div>
                                                                ...
                                                                <select name="typeaccount_id" class="form-control text-center" style=" width: 390px;" >
                                                                    ...
                                                                    if (isset($this->TypeAccountList))
                                                                        foreach ($this->TypeAccountList as $type) {
                                                                            ?>
                                                                            <option value="<?php echo $type->getTypeaccount_id(); ?>"><?php echo $type->getDescription(); ?></option>                        
                                                                            <?php
                                                                        }
                                                                    ?>
                                                                </select> 
                                                                ...
                                                                <select name="bank_id" class="form-control text-center" style=" width: 390px;" >
                                                                    ...
                                                                    if (isset($this->BankList))
                                                                        foreach ($this->BankList as $bank) {
                                                                            ?>
                                                                            <option value="<?php echo $bank->getBankbranch_id(); ?>"><?php echo $bank->getDescription(); ?></option>                        
                                                                            <?php
                                                                        }
                                                                    ?>
                                                                </select> 
                                                ...
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">  
                                                    <div class="form-group" style="width: 510px;  border: 0px #b92c28 solid;">
                                                        <div class="form-group"  style="width: 150px;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 150px;" class="form-control text-center" autofocus name="operation" id="InputOperation" placeholder="000000" pattern="[0-9]{0,10}">
                                                            </div>
                                                        </div> 
                                                        <div class="form-group"  style="width: 150px;">
                                                            <label for="InputAgency">Agência - Digito:</label>
                                                            <div>
                                                                <input type="text" style="width: 150px;" class="form-control text-center" autofocus name="agency" id="InputAgency" placeholder="000000-00" pattern="[0-9-]{0,10}">
                                                            </div>
                                                        </div>                                                          
                                                        <div class="form-group"  style="width: 200px;">
                                                            <label for="InputCurrentAccount">Conta Corrente - Digito:</label>
                                                            <div>
                                                                <input type="text" style="width: 200px;" class="form-control text-center" autofocus name="currentaccount" id="InputCurrentAccount" placeholder="00000-0/000" pattern="[0-9-/]{0,15}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group" style="width: 510px;  border: 0px #b92c28 solid;">
                                                        <div class="form-group" style="width: 500px;">
                                                            ...
                                                            <div>
                                                                <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="account_holder" id="InputAccountHolder" placeholder="Titular da Conta.." pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">  
                                                    <div class="form-group" style="width: 510px;">
                                                        <div class="form-group" style="width: 500px;">
                                                            ...
                                                            <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="refname" id="InputRefName" placeholder="Nome da Referência" pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                                        </div>   
                                                    </div>
                                                    <div class="form-group" style="width: 510px;">
                                                        <div class="form-group" style="width: 500px;">
                                                            <label class="control-label" for="InputRefAddress">Endereço:</label>
                                                            <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="refaddress" id="InputRefAddress" placeholder="Endereço da Referência" pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                                    <div class="form-group" style="width: 510px;">
                                                        <div class="form-group" style="width: 500px;">
                                                            ...
                                                            <input type="text" style="width: 200px;" class="form-control text-center" autofocus name="refphone" id="InputPhoneRef" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                        </div>
                                                    </div>  
                                                    <div class="form-group" style="width: 510px;">
                                                        <div class="form-group" style="width: 500px;">
                                                            <label class="control-label" for="InputEmailRef">E-mail:</label>
                                                            <input type="email" style="width: 300px;" class="form-control text-center" autofocus name="refemail" id="InputEmailRef" placeholder="E-mail" pattern="[a-z\u00C0-\u00ffA-Z._-@]{0,30}">
                                                        </div>
                                                    </div>                                                      
                                                </div>
                                            </div> 
                                                ...
                                                <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">  
                                                    <div class="form-group" style="width: 510px;">    
                                                        <div class="form-group" style="width: 350px; border: 0px #b92c28 solid; ">
                                                            ...
                                                            <select name="education_id" class="form-control text-center"style="width: 350px;" >
                                                                ...
                                                                <option value="10">Mestrado Incompleto</option>
                                                                <option value="9">Pós-graduação Completa</option>
                                                                <option value="8">Pós-graduação Incompleta</option>
                                                                <option value="7">Superior Completo</option>
                                                                <option value="6">Superior Incompleto</option>
                                                                <option value="15">Ensino Médio Técnico (2º Grau) Completo</option>
                                                                <option value="5">Ensino Médio (2º Grau) Completo</option>
                                                                <option value="14">Ensino Médio Técnico (2º Grau) Incompleto</option>
                                                                <option value="4">Ensino Médio (2º Grau) Incompleto</option>
                                                                <option value="3">Ensino Fundamental (1º Grau) Completo</option>
                                                                <option value="2">Ensino Fundamental (1º Grau) Incompleto</option>
                                                        ...
                                                        <div class="form-group" style="width: 150px;"> 
                                                            ...
                                                            <div class="form-group" style="width: 150px;">  
                                                                <input type="text" style="width: 150px;"  class="form-control text-center" autofocus name="yearcompletion" id="InputYearCompletion" placeholder="0000" onkeyup="maskIt(this, event, '####')" pattern="\d{4}">
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                    <div class="form-group" id="StaffDivOtherEducation" style="width: 510px; border: 0px #b92c28 solid;">
                                                        <div class="form-group"  style="width: 500px;">
                                                            ...
                                                            <div>
                                                                <textarea class="form-control left" style="width: 500px; height: 80px;" name="othereducation" id="InputOtherEducation"></textarea>                                        
                                                            </div> 
                                                        </div>
                                                    </div>                                                                                 
                                                </div>
                            ...
                            <div class="panel panel-primary"  style="width: auto; margin-top: 15px; margin-bottom: 15px; margin-right: 20px;">
                                ...
                                <div class="panel-body">
                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group" style="width: 570px;">
                                            <div class="form-group" style="width: 200px;">
                                                ...
                                                <input type="text" style="width: 195px;" class="form-control text-center" autofocus name="zipcode" id="InputZipCode" placeholder="Cep" onkeyup="maskIt(this, event, '#####-###')" required pattern="[0-9]{5}-[0-9]{3}">
                                    ...
                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group" style="width: 510px;">
                                            <div class="form-group" style="width: 400px;">
                                                ...
                                                <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="address" id="InputAddress" placeholder="Endereço" required pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                            </div>
                                            <div class="form-group" style="width: 100px;">
                                                <label class="control-label" for="InputAddrNumber">Número:</label>
                                                <input type="text" style="width: 100px;" class="form-control text-center" autofocus name="addr_number" id="InputAddrNumber" placeholder="Número" required pattern="[a-zA-Z0-9,\u00C0-\u00ff\s]{0,15}">
                                            </div>
                                        </div>
                                        <div class="form-group" style="width: 510px;">
                                            <label for="InputAddrComp">Complemento:</label>
                                            <div>
                                                <input type="text" style="width: 500px;" class="form-control text-center" autofocus name="addr_comp" id="InputAddrComp" placeholder="Complemento.." required pattern="[0-9a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                            </div>                                                        
                                        </div>                                          
                                    </div>
                                    ...
                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group" style="width: 510px;">
                                            <label for="InputFirstAddrDist">Bairro:</label>
                                            <div>
                                                <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="addr_dist" id="InputAddrDist" placeholder="Bairro ou Localidade" required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,30}">
                                            </div>
                                        </div>
                                        <div class="form-group" style="width: 510px;">
                                            <div class="form-group" style="width: 400px;">
                                                <label for="InputFirstAddrCity">Cidade:</label>
                                                <div>
                                                    <input type="text" style="width: 400px;" class="form-control text-center" autofocus name="addr_city" id="InputAddrCity" placeholder="Cidade" required pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,25}">
                                                </div>
                                            </div>
                                            <div class="form-group"  style="width: 100px;">
                                                <label for="InputFirstAddrState">Estado:</label>
                                                <div>
                                                    <input type="text" style="width: 100px;" class="form-control text-center" autofocus name="addr_state" id="InputAddrState" placeholder="Estado" required pattern="[a-zA-Z]{0,2}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline" style="margin-top: 10px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group" style="width: 510px;">
                                            ...
                                            <div>
                                                <input type="text" style="width: 510px;" class="form-control text-center" autofocus name="addr_ref" id="InputAddrRef" placeholder="Referência.." pattern="[a-z\u00C0-\u00ffA-Z._-\s]{0,40}">
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group"  style="width: 510px;">
                                            <div class="form-group"  style="width: 250px;">
                                                ...
                                                <div>
                                                    <input type="tel" style="width: 250px;" class="form-control text-center" autofocus name="home_phone" id="InputHomePhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                </div>
                                            </div>
                                            <div class="form-group"  style="width: 250px;">
                                                <label for="InputMobilPhone">Celular:</label>
                                                <div>
                                                    <input type="tel" style="width: 250px;" class="form-control text-center" autofocus name="mobil_phone" id="InputMobilPhone" placeholder="(00)00000-0000" onkeyup="maskIt(this, event, '(##)#####-####')" pattern="\([0-9]{2}\)([0-9\s-]{1})?[0-9]{4}-[0-9]{4}">
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="form-group"  style="width: 510px;">
                                            <div class="form-group"  style="width: 250px; ">
                                                ...
                                                <div>
                                                    <input type="tel" style="width: 250px;" class="form-control text-center" autofocus name="nextel_phone" id="InputNextelPhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                </div>
                                            </div>
                                            <div class="form-group"  style="width: 250px;">
                                                <label for="InputNextelID">Nextel ID:</label>
                                                <div>
                                                    <input type="text" style="width: 250px;" class="form-control text-center" autofocus name="nextel_id" id="InputNextelID" placeholder="99*999999"  pattern="[0-9*]{0,9}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group"  style="width: 510px;">
                                            <div class="form-group"  style="width: 250px;">
                                                ...
                                                <div>
                                                    <input type="tel" style="width: 250px;" class="form-control text-center" autofocus name="contact_phone" id="InputContactPhone" placeholder="(00)0000-0000" onkeyup="maskIt(this, event, '(##)####-####')" pattern="\([0-9]{2}\)[0-9]{4}-[0-9]{4}">
                                                </div>
                                            </div>
                                            <div class="form-group"  style="width: 250px;">
                                                <label for="InputContactMobil">Celular Para Contato:</label>
                                                <div>
                                                    <input type="tel" style="width: 250px;" class="form-control text-center" autofocus name="contact_mobil" id="InputContactMobil" placeholder="(00)00000-0000" onkeyup="maskIt(this, event, '(##)#####-####')" pattern="\([0-9]{2}\)([0-9\s-]{1})?[0-9]{4}-[0-9]{4}">
                                                </div> 
                                            </div>
                                        </div>
                                        <div class="form-group"  style="width: 510px; ">
                                            ...
                                            <div>
                                                <input type="text" style="width: 505px;" class="form-control text-center" autofocus name="contact_name" id="InputContactName" placeholder="Nome para Contato..."  pattern="[a-z\u00C0-\u00ffA-Z,._-\s]{0,40}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group"  style="width: 510px;">
                                            ...
                                            <div>
                                                <input type="email" style="width: 510px;" class="form-control text-center" name="email" id="InputEmail" placeholder="nome@provedora.com.br">
                                            </div>                                            
                                        </div>
                                        <div class="form-group"  style="width: 510px;">
                                            <label for="InputNote">Observação:</label>
                                            <div>
                                                <textarea class="form-control left" style="width: 510px;" name="contact_msg" id="InputNote"></textarea>                                        
                                            </div>                                             
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-inline" style="margin-top: 5px; margin-left: 5px; margin-bottom: 10px;">
                                        <div class="form-group"  style="width: 1030px; height: 150px;">
                                            ...
                                            <div>
                                                <textarea class="form-control left" style="width: 1030px; height: 130px;" name="staff_msg" id="InputStaffNote"></textarea>                                        
                                            </div>                                             
                                        </div>
                                    </div>
                                </div>                                
...
<script>
    ...
    $(document).on("click", "#OpenModalUpload", function () {
        //
        var company_id = $('#SELCompanyID').val();
        var local_acronym = $('#SELLocal').val();
        var staff_id = $('#InputHStaffID').val();
        var person_id = $('#InputHPersonID').val();
        //  console.log(person_id);
        var customer_id = $('#SELCustomerID').val();
        var staff_name = $('#InputName').val();
        var staff_surname = $('#InputSurname').val();
        //
        $(".modal-body #CompanyID").val(company_id);
        $(".modal-body #LocalID").val(local_acronym);
        $(".modal-body #StaffID").val(staff_id);
        $(".modal-body #PersonID").val(person_id);
        $(".modal-body #CustomerID").val(customer_id);
        $(".modal-body #Name").val(staff_name);
        $(".modal-body #Surname").val(staff_surname);
        //
    });
